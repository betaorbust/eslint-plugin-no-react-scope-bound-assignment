...
function noJsxScopeBoundWrites(context) {
    ...
    var WARNING_MESSAGE = '{{name}} is initialized outside of a react class, but reassigned within one.';
    ...
    function insideReactCreateClass(ref){
        if(ref.type === 'CallExpression' &&
            ...
            ref.callee.object && ref.callee.object.name === 'React' &&
            ref.callee.property && ref.callee.property.name === 'createClass'){
            return true;
        }
